            ...
            @foreach($menus as $items)
                @if($items->cat_id == $category->id)
                    <div class="col-xl-3 col-lg-6 col-md-12">
                        <a href="{{ URL::to('vendor/item/edit/'.$items->id) }}">
                            <div class="card" style="height: 499.203px;">
                                <div class="card-body">
                                    <img class="card-img-top img-fluid" src="{{asset('storage/app/public/item/'.$items->image)}}" alt="Card image cap">
                                    <div class="card-block mt-3">
                                        ...
                                        @if($items->is_available == "1")
                                            <p class="font-medium-2 success mt-3">{{trans('labels.available')}}</p>
                                        @else
                                            <p class="font-medium-2 danger mt-3">{{trans('labels.unavailable')}}</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
                ...
                @endif
            @endforeach
    	    	<div class="col-xl-3 col-lg-6 col-md-12 add-item" data-cat-id="{{$category->id}}" data-category-name="{{$category->name}}">
                    <div class="card" style="height: 499.203px;">
                        <div class="card-body">
