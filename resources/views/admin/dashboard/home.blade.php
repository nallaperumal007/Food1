					...
					<div class="media">
						<div class="media-body white">
							<div class="row justify-content-space-evenly">
                                ...
                                @else
                                <a href="https://web.whatsapp.com/send?text={{URL::to('/')}}/{{Auth::user()->slug}}" target="_blank" class="btn btn-social btn-min-width btn-adn-flat mr-2 mb-2 btn-adn"><i class="fa-brands fa-whatsapp text-wa-color"></i> {{trans('labels.whatsapp')}}</a>
                                @endif
								</div>
								<div class="media-body white">
