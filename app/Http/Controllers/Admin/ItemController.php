...
class ItemController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $mdata = Item::where('id',$id)->where('restaurant',Auth::user()->id)->first();
        $extras = Extra::where('item_id',$id)->where('restaurant',Auth::user()->id)->orderBy('id', 'DESC')->get();
        $variants = Variants::where('item_id',$id)->where('restaurant',Auth::user()->id)->orderBy('id', 'DESC')->get();
