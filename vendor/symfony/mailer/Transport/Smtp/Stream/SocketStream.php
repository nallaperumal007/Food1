...
final class SocketStream extends AbstractStream
{
    ...
    public function initialize(): void
    {
        ...
        $options['ssl']['_method'] = $options['ssl']['_method'] ?? \STREAM__METHOD_TLS_CLIENT | \STREAM__METHOD_TLSv1_2_CLIENT | \STREAM__METHOD_TLSv1_1_CLIENT;
    ...
    public function startTLS(): bool
    {
        ...
        try {
            return stream_socket_enable_($this->stream, true);
        } finally {
            restore_error_handler();
        }
    }
